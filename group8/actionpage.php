...
<?PHP
	...
	$doctors1 = $_POST["doctors"];
	$date1 = $_POST["appointDate"];
	$time1 = $_POST["time"];
	$dateAndtime1 = $date.$time;
	$id1 = $_POST["id"];
	$sql = "INSERT INTO MyAppointments (doctors, dateAndtime, id) VALUES ('$doctors1', '$dateAndtime1', '$id1')";
