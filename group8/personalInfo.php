	...
	<div id="page">
		...
		<div id="content">
			...
			<?php
				...
				$sql = "SELECT id, firstname, lastname, email, birth, address, insurance, pass FROM MyPatients WHERE id = " . $username;
				$result = $conn->query($sql);
				if ($result->num_rows > 0) {
    				// output data of each row
    					while($row = $result->fetch_assoc()) {
						if($row["pass"] == $password)
        						echo "User ID: " . $row["id"]."<br>"."<br>"."User Name: ".$row["firstname"]." ".$row["lastname"]."<br>"."<br>"."User Email: ".$row["email"]."<br><br>"."User Birth: ".$row["birth"]."<br><br>"."User Address: ".$row["address"]."<br><br>"."User Insurance: ".$row["insurance"]."<br><br>"."User Password: ".$row["pass"]."<br>";
						else echo "0 results";
    					}
				} else {
   					 echo "0 results";
